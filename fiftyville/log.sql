...
-- "The thief stole the duck and then, shortly afterwards, took a flight out of town with the help of an accomplice."
...
-- Witnesses:
-- 1. Ruth: The thief left the bakery parking lot in a car within 10 minutes of theft. (3)
-- 2. Eugene: Thief withdrew money from ATM on Leggett Street before the theft. (4)
-- 3. Raymond: Thief planned to take earliest flight the next day. (5)
-- 4. Emma(redundant)


-- Identify cars that left the bakery 10 minutes after the theft
...
-- 4. Get Leggett Street's atm logs before the theft
...
-- 5. Find out the first flight on July 29, 2021
...
-- ANSWER 1: The thief went to New York City

-- 6. Match license plate with bank account number and flight information
SELECT name
FROM people
...
/*
    Remaining suspects' possible accomplice
    1. James
    2. Robin
    3. Doris
*/

-- Bruce called Robin for less than one minute
-- The thief is Bruce
-- The accomplice is Robinne